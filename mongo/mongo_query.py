...
collection = client[os.getenv('DB_NAME')][os.getenv('USER_COLLECTION')]

# initialize vector store
vectorStore = MongoDBAtlasVectorSearch(
    collection, OpenAIEmbeddings(openai_api_key=os.getenv('OPENAI_API_KEY')), index_name=params.index_name
)
